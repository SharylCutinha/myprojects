<template>
  <div class="w-full bg-[#29272a]">
    <nav class="mx-auto container p-4 flex justify-between">
      <div class="">
        <div class="group inline-block">
          <div
            class="outline-none focus:outline-none pr-3 text-white flex items-center"
          >
            <span class="pr-1 font-semibold flex-1">More Options</span>
            <span class="mt-1">
              <SvgoDownArrow class="fill-current h-4 w-4 transform group-hover:-rotate-180 transition duration-150 ease-in-out" />
            </span>
          </div>
